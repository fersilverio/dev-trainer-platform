<template>
    <RouterLink :to="{ name: 'kanban', params: { projectId: props.project.id } }">
        <div
            ...
            <div class="flex justify-between items-center">
                <p class="text-white text-xl font-bold">{{ projectCardFullTitle }}</p>
...
const projectCardFullTitle = `[${props.project.code}]  ${props.project.name}`;
